---
title: 'Sending text'
description: 'Send text to Telegram, Discord, Slack, ntfy, Mastodon and Bluesky with one verb. Formatting differs per service, and every limit is checked before sending.'
---
