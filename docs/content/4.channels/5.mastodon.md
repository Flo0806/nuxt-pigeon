---
title: 'Mastodon'
description: 'Post to Mastodon from Nuxt with an access token: visibility, content warnings, images, editing and deleting, plus polled notifications for your own account.'
---
...
- **The first poll only marks where we are.** Trigger something _after_ the server
